...
<header class="bg-black">
  <div class="max-w-6xl mx-auto px-4 pb-4">
    ...
    <div class="flex space-x-4">
      ...
      <!-- Brand -->
      <div class="group flex-1 shadow bg-gray-800 rounded-lg px-4 py-3 border-t border-gray-700 cursor-pointer">
      ...
      <!-- Focal Length -->
      <div class="group w-48 shadow bg-gray-800 rounded-lg px-4 py-3 border-t border-gray-700 cursor-pointer">
        <div class="mb-1 uppercase font-bold font-base text-sm tracking-wider text-gray-500 transition-colors group-hover:text-gray-200">
          Fookuskaugus
        </div>
        <div class="flex font-medium text-lg space-x-1">
          <div class="px-2 py-0.5 text-gray-200 rounded-md bg-black border-b border-gray-700 transition-colors">18</div>
          <div class="py-0.5 text-gray-500">–</div>
          <div class="px-2 py-0.5 text-gray-200 rounded-md bg-black border-b border-gray-700 transition-colors">50</div>
          <div class="py-0.5 text-gray-500">mm</div>
        </div>
      </div>

      <!-- Aperture -->
      <div class="group w-32 shadow bg-gray-800 rounded-lg px-4 py-3 border-t border-gray-700 cursor-pointer">
        <div class="mb-1 uppercase font-bold font-base text-sm tracking-wider text-gray-500 transition-colors group-hover:text-gray-200">
          Ava
        </div>
        <div class="flex font-medium text-lg space-x-1">
          <div class="py-0.5 text-gray-500">f/</div>
          <div class="px-2 py-0.5 text-gray-200 rounded-md bg-black border-b border-gray-700">2</div>
          <div class="py-0.5 text-gray-500">–</div>
          <div class="px-2 py-0.5 text-gray-200 rounded-md bg-black border-b border-gray-700">4</div>
        </div>
      </div>
